...
int main(int argc, char **argv)
{
    ...
    skip = MakeSkip(str2, len2);   //建立坏字符表

    shift = MakeShift(str2, len2);   //建立好后缀字符表

    num = BMSearch(str1, len1, str2, len2,skip, shift);
