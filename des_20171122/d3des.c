...
void des2key(unsigned char  *hexkey /* stomps on Kn3 too */,short  mode/* unsigned char[16] */)       
{  
    short revmod;  
...
void makekey(register char *aptr    /* NULL-terminated  */, register unsigned char *kptr    /* unsigned char[8] */)  
{  
...
void make2key(register char *aptr/* NULL-terminated   */, register unsigned char *kptr      /* unsigned char[16] */)  
{  
    register unsigned char *store;  
    register int first, i;  
    unsigned long savek[96];  
...
void cp3key(register unsigned long *into    /* unsigned long[96] */)  
{  
    register unsigned long *from, *endp;  
...
void use3key(register unsigned long *from   /* unsigned long[96] */)  
{  
    register unsigned long *to, *endp;  
...
void make3key(register char *aptr               /* NULL-terminated   */, register unsigned char *kptr       /* unsigned char[24] */)  
{  
    register unsigned char *store;  
    register int first, i;  
    unsigned long savek[96];  
